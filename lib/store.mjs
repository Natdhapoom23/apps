...
async function load() { if (!memory) { try { memory=JSON.parse(await readFile(file,'utf8')); } catch(e) { if(e.code!=='ENOENT')throw e; memory={rooms:{},index:{},boards:{},limits:{}}; } memory.boards ||= {}; } return memory; }
